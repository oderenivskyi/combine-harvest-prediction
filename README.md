...
### Бізнес-використання
Модель опубліковано у вигляді веб-додатка на **Streamlit**. На даному етапі для отримання прогнозу потрібно завантажити Excel-файл відповідної структури з запланованою технікою та погодними ознаками, а система побудує графік очікуваного виробітку на зміну. Приклад Excel-файла для тестування є у репозиторії (Назва).
